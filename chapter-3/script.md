...
код в кавычка становится просто строкой. Попробуем несколько
вариантов...
...
должен занимать фрагмент. Для этого укажите число между процентом и
...
фрагмент будет занимать либо указанное количество символов, либо
...
Попробуем это все на деле... [вот тут будет длинное виде, в котором я
показываю все, что говорил выше, сопровождая это примерно такой же
речью.]
...
[аналогичное видео с подробным рассказом о срезах. Знаешь что, я
сделаю это видео со звуком. Оно будет достаточно техническим, так что
сам материал править не получится. Стилистику моего изложения уже
можно было понять, так что звук будет просто чтобы можно было сразу
сделать замечания.]
