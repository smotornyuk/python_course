...
Подобным образом работают две точны, хоть их кпд значительно выше. Они
...
текущим местоположением. Забыл сразу заметить - в unix системах вы
...
команда - pwd. В windows такой команды нет, да она и не нужно - так
...
запас. Так, например реализовано все в linux ubuntu. Попробуйте
...
код, переданный аргументом и многое другой. В большинстве случаев вам
