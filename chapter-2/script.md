...
присмотреться, что можно заметить, что минус перед второй переменной -
...
всегда само меньшее число. Это и логично - его нельзя 10 разделить
...
переменной справа от символа равно. Потом переносим оператор операции
...
развлекаться. Кстати, количество аргументов тут неограниченно - все
